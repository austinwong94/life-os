...
const allowed = new Set(['index.html', 'styles.css', 'experience.css', 'app.js', 'experience.js', 'planner-store.js', 'state-merge.js', 'device-store.js', 'restore-review.js', 'note-actions.js', 'dev-redirect.js']);
